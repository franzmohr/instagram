...
ggsave(g, filename = "pics/20200803_gdp_component_growth_de.jpeg", height = 5, width = 5)
...
ggsave(g, filename = "pics/20200803_gdp_components_growth_en.jpeg", height = 5, width = 5)
